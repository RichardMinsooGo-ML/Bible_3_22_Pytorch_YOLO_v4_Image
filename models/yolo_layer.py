...
# from utils.iou_rotated_boxes_utils import iou_pred_vs_target_boxes, iou_rotated_boxes_targets_vs_anchors, get_polygons_areas_fix_xy
...
class YoloLayer(nn.Module):
    ...
    def compute_grid_offsets(self, grid_size):
        ...
        self.scaled_anchors = torch.tensor([(a_w / self.stride, a_h / self.stride) 
             for a_w, a_h in self.anchors], device=self.device, dtype=torch.float)
